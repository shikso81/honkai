...
bot_token = input(f'{COLOR_CODE["RED"]}Введите токен вашего бота (если захотите выйти, введите 9 и нажмите Enter):{COLOR_CODE["RESET"]}')

if bot_token == "9":
    print(f'{COLOR_CODE["RED"]}Переходик...{COLOR_CODE["RESET"]}')
else:
